					...
					<form action="bbsController?type=writeResult" method="post">
						...
						<table>
							...
							<tbody>
								<tr>
									<th>상품번호</th>
									<td><select name="productno" title="상품번호">
								...
								<tr>
									<th>작성자</th>
									<td><input readonly type="text" name="id" size="12"
										title="작성자" value="${sessionScope.id }"></td>
								</tr>
								<tr>
									<th>문의종류</th>
							...
							<tfoot>
								<tr>
									<td colspan="2"><input type="button" value="저 장"
										onclick="sendData()"> <input type="button" value="목 록" class="button"
